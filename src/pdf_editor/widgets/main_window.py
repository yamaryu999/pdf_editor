...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def _build_ui(self) -> None:
        ...
        up_button.setToolButtonStyle(QtCore.Qt.ToolButtonTextBesideIcon)
        up_button.setDefaultAction(self.move_page_up_action)
        down_button = QtWidgets.QToolButton()
        down_button.setToolButtonStyle(QtCore.Qt.ToolButtonTextBesideIcon)
        down_button.setDefaultAction(self.move_page_down_action)
